...
namespace PisApp.API.Repositories
{
    public class CompatibleRepository : ICompatibleRepository
    {
        ...
        {
            var query = "SELECT COUNT(*) FROM compatible_cc_socket WHERE cpu_id = @p0 AND cooler_id = @p1)";
        ...
        {
            var query = "SELECT COUNT(*) FROM compatible_gp_connector WHERE gpu_id = @p0 AND power_supply_id = @p1";
        ...
        {
            var query = "SELECT COUNT(*) FROM compatible_mc_socket WHERE cpu_id = @p0 AND motherboard_id = @p1";
        ...
        {
            var query = "SELECT COUNT(*) FROM compatible_rm_slot WHERE ram_id = @p0 AND motherboard_id = @P1";
        ...
        {
            var query = "SELECT COUNT(*) FROM compatible_gm_slot WHERE gpu_id = @p0 AND motherboard_id = @p1";
        ...
        {
            var query = "SELECT COUNT(*) FROM compatible_sm_slot WHERE ssd_id = @p0 AND motherboard_id = @p1";
